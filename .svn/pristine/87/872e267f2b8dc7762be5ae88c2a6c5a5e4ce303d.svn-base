<%@page import="com.csslect.app.dto.JoongbokDTO"%>
<%@page import="com.csslect.app.dto.HanMemberDTO"%>
<%@page import="com.csslect.app.dto.AnMemberDto"%>
...
<%		
	Gson gson = new Gson();
	String json = gson.toJson((ArrayList<JoongbokDTO>)request.getAttribute("JoongbokNick"));
