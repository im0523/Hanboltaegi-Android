<%@page import="com.csslect.app.dto.CommunityDTO"%>
<%@page import="com.csslect.app.dto.AnInquiryDTO"%>
...
<%		
	Gson gson = new Gson();
	String json = gson.toJson((ArrayList<CommunityDTO>)request.getAttribute("Comment"));
